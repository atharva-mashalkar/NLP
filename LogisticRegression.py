...
#     * For each word, check the `freqs` dictionary for the count# combine positive and negative labels
 when that word has a positive '1' label. (Check for the key (word, 1.0)
...
# ## Part 3: Training # combine positive and negative labels
Your Model
# 
# To train the model:
